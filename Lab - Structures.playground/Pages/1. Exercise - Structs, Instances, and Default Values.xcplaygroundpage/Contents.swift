...
var somePlace = Person()
print(somePlace.latitude, somePlace.longitude)

//:  Change `somePlace`'s latitude to 51.514004, and the longitude to 0.125226, then print the updated values.
var somePlaces = Person(latitude: 51.514004, longitude: 0.125226)
print(somePlaces.latitude, somePlaces.longitude)
...
var favoriteBook = Book(title: "Diary of a Wimpy Kid", author: "Jeff Kinney", pages: 221, price: 17)
