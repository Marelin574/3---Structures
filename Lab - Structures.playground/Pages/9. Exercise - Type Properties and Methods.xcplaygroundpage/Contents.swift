...
struct User {
    ...
    static var currentUser = User(userName: "Marelin574", email: "mcaxramos@gmail.com", age: 17)
    
    static func logIn(h:User){
        currentUser = h
    }
}
var newUser = User(userName: "Marelin123", email: "antigua@gmail.com", age: 31)

User.logIn(h: newUser)
